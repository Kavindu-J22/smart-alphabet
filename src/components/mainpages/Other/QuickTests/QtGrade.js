                    ...
                    <div className='v-cards'>
                        <div className='v-text-card'>
                            <div className='v-content '>
                                ...
                                <Link className='v-link' to="/Qtgrade/Qtnine">Explore</Link>
                            </div>
                        </div>
                        ...
                        <div className='v-text-card'>
                            <div className='v-content'>
                                ...
                                <h3>10 ශ්‍රේණිය</h3>
                                <h5>“අයන්න කියන්න” නමින් සිංහල සඟරාවක් පළ කිරීමේ අවශ්‍යතාව අප තුළ ඇතිව තිබූයේ මීට වසර ගණනාවකට ඔබ්බෙහි සිට ය.</h5>   
                                <Link className='v-link' to="/Qtgrade/QtTen">Explore</Link>
                                </div>
                        </div>
                        ...
                        <div className='v-text-card'>
                            <div className='v-content'>
                                ...
                                <h3>11 ශ්‍රේණිය</h3>
                                <h5>“අයන්න කියන්න” නමින් සිංහල සඟරාවක් පළ කිරීමේ අවශ්‍යතාව අප තුළ ඇතිව තිබූයේ මීට වසර ගණනාවකට ඔබ්බෙහි සිට ය.</h5>   
                                <Link className='v-link' to="/Qtgrade/QtEleven">Explore</Link>
                                </div>
                        </div>
                        ...
                        <div className='v-text-card'>
                            <div className='v-content'>
                                ...
                                <h3>A/L</h3>
                                <h5>“අයන්න කියන්න” නමින් සිංහල සඟරාවක් පළ කිරීමේ අවශ්‍යතාව අප තුළ ඇතිව තිබූයේ මීට වසර ගණනාවකට ඔබ්බෙහි සිට ය.</h5>   
                                <Link className='v-link' to="/Qtgrade/QtAl">Explore</Link>
                                </div>
                        </div>
